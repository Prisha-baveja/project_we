...
const ContactsContainer = () => {
  ...
  return (
    <div className='relative md:w-[35vw] lg:w-[30vw] xl:w-[20vw] bg-[#1b1c24] border-r-4 border-[#2f303b] w-full scrollbar-hidden-track'>
      <div className="p-3">
        <Logo />
      </div>
...
const Logo = () => {
  return (
    <div className="flex p-5 justify-start items-center gap-2">
      ...
      <span className="text-3xl font-semibold ">DevConnect</span>
    </div>
  );
};
